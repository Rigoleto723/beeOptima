...
# También puedes habilitar esto temporalmente para desarrollo
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(hours=config('JWT_REFRESH_TOKEN_LIFETIME', default=8, cast=int)),
